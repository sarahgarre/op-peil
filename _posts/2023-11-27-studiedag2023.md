...
<object data="./assets/docu/Begeleidingsgroep3_OPPEIL.pdf)" type="application/pdf" width="300px" >
    <embed src="./assets/docu/Begeleidingsgroep3_OPPEIL.pdf)">
        <p>This browser does not support PDFs. Please download the PDF to view it: <a href="./assets/docu/Begeleidingsgroep3_OPPEIL.pdf)">Download PDF</a>.</p>
    </embed>
</object>
